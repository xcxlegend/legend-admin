...
;layui.define("view", function(e) {
    var a = layui.jquery
        ...
        sendAuthCode: function(e) {
            ...
            var i, t = e.seconds, n = a(e.elem), l = function(a) {
                t--,
                    t < 0 ? (n.removeClass(f).html("获取验证码"),
                        t = e.seconds,
                        clearInterval(i)) : n.addClass(f).html(t + "秒后重获"),
        ...
        sideFlexible: function(e) {
            var i = u
                , t = a("#" + h)
                , l = P.screen();
            "spread" === e ? (t.removeClass(x).addClass(g),
                l < 2 ? i.addClass(v) : i.removeClass(v),
                i.removeClass(C)) : (t.removeClass(g).addClass(x),
        ...
        resize: function(e) {
            var a = layui.router()
                , i = a.path.join("-");
            P.resizeFn[i] && (r.off("resize", P.resizeFn[i]),
                delete P.resizeFn[i]),
            "off" !== e && (e(),
                P.resizeFn[i] = e,
                r.on("resize", P.resizeFn[i]))
        },
        resizeFn: {},
        runResize: function() {
            var e = layui.router()
        ...
        fullscreen: function(e) {
            var a = "layui-icon-screen-full"
                ...
                , t = e.children("i");
            t.hasClass(a) ? (P.fullScreen(),
                t.addClass(i).removeClass(a)) : (P.exitScreen(),
        ...
        setTheme: function(e) {
            ...
            e.hasClass(y) || (e.addClass(y).siblings(".layui-this").removeClass(y),
                P.initTheme(a))
        },
        ...
        closeOtherTabs: function(e) {
            ...
            "all" === e ? (a(z + ":gt(0)").remove(),
                a(m).find("." + b + ":gt(0)").remove(),
                a(z).eq(0).trigger("click")) : (a(z).each(function(e, t) {
                e && e != P.tabsPage.index && (a(t).addClass(i),
                    P.tabsBody(e).addClass(i))
            }),
                a("." + i).remove())
        },
    ...
    !function() {
        ...
        t.on("nav(layadmin-system-side-menu)", function(e) {
            e.siblings(".layui-nav-child")[0] && u.hasClass(C) && (P.sideFlexible("spread"),
